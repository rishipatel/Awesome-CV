...
\address{No. 657, 3rd floor, 25th cross, 9th main, HSR Layout sector-7, Bangalore (India)}
\mobile{(+91) 9008948452}
\email{ank23rishi@gmail.com}
\homepage{https://medium.com/@rishipatel23}
%\github{rishipatel}
\linkedin{rishipatel23}
% \gitlab{gitlab-id}
